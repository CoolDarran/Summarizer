...
public class CSentenceDistance {
    
    //根据向量计算cosine相似度
	public double getSimilarity1(CSentence s1,CSentence s2){
		double numerator = 0;
	 ...
	 * 根据编辑距离计算两句子间相似度
	 */
	public static double getSimilarity2(CSentence s1, CSentence s2){
	...
	//根据最长公共子序列计算相似度
	public static double getSimilarity3(CSentence s1, CSentence s2){
...
//		System.out.println("\n" + comStr.length);
	...
	public static void main(String[] args){
		String[] s1 = {"v6","n3","n19","v6","n4"};
		String[] s2 = {"n25","n4","v6","n3","n5"};
		comSubstring(s1,s2);
		System.out.println(getEditDist(s1, s2));
	}
